        ...
        <div class="card-body">
          <div class="img">
            <div class="row">
              ...
              $query = "SELECT * FROM video_gellery ORDER BY created_at DESC limit $limit offset $offset";
          ...
          <?php
          $pagination = "SELECT * FROM video_gellery";
            ...
            <ul class="pagination pt-5 pb-5">
              ...
              ?>
                <li class="page-item <?= ($i == $page) ? $active = 'active' : ''; ?>">
                  <a href="vide-gellery.php?page=<?= $i ?>" class="page-link"><?= $i ?></a>
                </li>
              <?php } ?>
            </ul>
          <?php } ?>
