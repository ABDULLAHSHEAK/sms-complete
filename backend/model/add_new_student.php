...
if (isset($_POST['submit'])) {
 ...
 if (in_array($fileExt, $extension)) {
  ...
  $query = "INSERT INTO student (full_name,fa_name,ma_name,student_phone,student_fa_phone,email,student_address,birth_date,gender,roll,reg,class_name,slug,img) VALUES ($full_name,$fa_name,$ma_name,$student_phone,$student_fa_phone,$email,$student_address,$birth_date,$gender,$roll,$reg,$class_name,$slug,$filename)";
  $run = mysqli_query($conn, $query);
  if ($run) {
   move_uploaded_file($tempName, $upload);
   header('Location: student.php'); 
   $teacher_alert = "Student Added Succesfully";
  } else {
   echo "error";
  }
 } else {
