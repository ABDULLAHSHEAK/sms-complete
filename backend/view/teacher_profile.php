				...
				<div class="panel"><!--panel bg-maroon-->
					...
					<div class="panel-body"><!--panel-body -->
						<div class="row" id="my_profile">
							<div class="col-md-3">
								<img id="photo2" alt="User Pic" src="teacher/<?php echo $row['image_name'] ?>" class="img-circle img-responsive">
							</div>
							<div class=" col-md-9">
					...
					<div class="panel-footer text-right" id="panel_footer">
						<a href="all_teacher.php" class="btn btn-sm btn-warning">Back</a>
