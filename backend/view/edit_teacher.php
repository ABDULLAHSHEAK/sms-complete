...
<?php include('../model/update_teacher.php'); ?>
<?php
   ...
   <div class="col-md-7">
    ...
    <div class="box box-primary">
     <div class="box-header with-border">
      <div class="row">
       <div class="col-lg-10">
        <h3 class="text-white">Edit Teacher</h3>

       </div>
       <div class="col-lg-2">
        <h3>
         <a href="all_teacher.php" class="btn btn-success btn-sm">Back
         </a>
        </h3>
       </div>
      </div>
     ...
     <form role="form" action="" method="POST" enctype="multipart/form-data" id="form1" class="form-horizontal">
      <div class="box-body">
       ...
       <div class="form-group" id="divAddress">
        ...
        <div class="col-xs-9">
         <input type="text" class="form-control" placeholder="Teacher Address" name="address" autocomplete="off" value="<?= $result['address'] ?>">
        </div>
       </div>
       <!-- -------- gender -------------  -->
       ...
       <div class="form-group" id="divPhone">
        ...
        <div class="col-xs-4" id="divPhone1">
         <input type="tel" class="form-control" placeholder="0123-456-7890" name="phone" id="phone" autocomplete="off" value="<?= $result['phone'] ?>">
        </div>
       </div>
       <!-- -------- email -------------  -->
       ...
       <div class="form-group" id="divPhoto">
        ...
        <div class="col-xs-3" id="divPhoto1" style="height:150px;">
         <img src="teacher/<?= $result['image_name'] ?>" id="output" style="width:130px;height:150px;" />
         <h4><?= $file_error ?></h4>
      ...
      <div class="box-footer">
       <button type="submit" class="btn btn-primary" id="btnSubmit" name="update_teacher">Save Changes</button>
      </div>
     </form>
    </div><!-- /.box -->
   </div>
