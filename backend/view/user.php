    ...
    <div class="box box-primary">
     <div class="box-header with-border">
      ...
      <div class="row">
       ...
       <div class="col-lg-2">
        <h3>
         <a href="all_users.php" class="btn btn-success btn-sm">View
         </a>
        </h3>
       </div>
      </div>
     ...
     <form role="form" action="" method="POST" enctype="multipart/form-data" id="form1" class="form-horizontal">
      <div class="box-body">
       ...
       <div class="form-group" id="divIName">
        ...
        <div class="col-xs-9">
         <input type="text" class="form-control" placeholder="User Name" name="user_name" id="i_name" autocomplete="off" required>
        </div>
       </div>
       <!-- -------- gender -------------  -->
       ...
       <div class="form-group" id="divPhone">
        ...
        <div class="col-xs-9">
         <input type="text" class="form-control" placeholder="Enter Address" name="address" id="full_name" autocomplete="off">
        </div>
       </div>
       <!-- -------- Number -------------  -->
       <div class="form-group" id="divPhone">
        ...
        <div class="col-xs-4" id="divPhone1">
         <input type="text" class="form-control" placeholder="0123-456-7890" name="phone" id="phone" autocomplete="off">
        </div>
       </div>
       <!-- -------- email -------------  -->
       <div class="form-group tt2 " id="divEmail">
        ...
        <div class="col-xs-6" id="divEmail1">
         <input type="email" class="form-control" placeholder="Enter valid email address" name="email" id="email" autocomplete="off" required>
        </div>
       </div>
       <!-- -------- Password -------------  -->
       <div class="form-group tt2 " id="divEmail">
