...
?>
<?php include('../model/delete_result.php'); ?>
            ...
            <div class="col-md-10">
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h4><?php echo $result_delete ?></h4>
                                <h3 class="text-white">All Result</h3>
                            </div>
                            <div class="col-lg-2">
                                <h3>
                                    <a href="result.php" class="btn btn-success btn-sm">Add Result
                    ...
                    <div class="box-body table-responsive" style="overflow-x:auto;">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT r.id ,r.file,r.result_title , r.date , c.name FROM result r LEFT JOIN class_room c ON r.class_id = c.id ORDER BY date DESC";
                                            ...
                                            <td>
                                                <div style="display: flex;">
                                                    ...
                                                    <div style="margin-right: 5px;">
                                                        <form action="">
                                                            <a href="edit_result.php?editId=<?= $id ?>" class="btn btn-info btn-xs">Edit</a>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div style="margin-right: 5px;">
                                                        ...
                                                        <form action="" class="mt-2" method="POST" onsubmit="return confirm('Are you sure want to delete ?')" enctype="multipart/form-data">
                                                            ...
                                                            <button type="submit" name="delete_result" value="Delete" class="confirm-delete btn btn-danger btn-xs">Delete</button>
                                                        </form>
                                                    </div>
