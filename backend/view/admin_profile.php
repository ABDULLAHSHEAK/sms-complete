				...
				<div class="panel"><!--panel bg-maroon-->
					...
					<div class="panel-body"><!--panel-body -->
						<div class="row" id="my_profile">
							<div class="col-md-3">
								<img id="photo2" alt="User Pic" src="users/<?php echo $image; ?>" class="img-circle img-responsive">
							</div>
							<div class=" col-md-9">
					...
					<div class="panel-footer text-right" id="panel_footer">
						<a href="edit_user.php?editId=<?= $user_id ?>" type="button" class="btn btn-sm btn-warning" id="btnEdit"><i class="glyphicon glyphicon-edit"></i></a>
					</div>
				</div><!--/. panel-->
			</div>
		</div><!--/.row -->
