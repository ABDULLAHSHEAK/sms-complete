...
?>
<?php include('../model/media-gellery.php'); ?>
...
<div class="content-wrapper">
 ...
 <section class="content"> <!-- Start of table section -->
  <div class="row" id="table1"><!--MSK-000132-1-->
   <div class="col-md-12">
    <div class="box" style="background: #222d32;">
         ...
         <div class="col-md-2 col-sm-4 col-6">
          <div class="photo">
            ...
            if(isset($_GET['page'])){
              ...
              if($page == 1){
                ?>
              <a href="site_image.php?image=<?=$photo_id?>"><img class="gellery" src="media/<?= $name ?>" alt="gellery_img"></a>
              <?php
              }else if($page == 0){
                ?>
           <a href="sidebar_setting.php?image=<?=$photo_id?>"><img class="gellery" src="media/<?= $name ?>" alt="gellery_img"></a>
           <?php
              }else if($page == 2){
                ?>
                 <a href=""><img class="gellery" src="media/<?= $name ?>" alt="gellery_img"></a>
                 <?php
              }
            }
            ?>
