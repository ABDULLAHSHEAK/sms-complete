...
?>
<?php include('../model/delete_committee.php'); ?>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h4><?php echo $cm_delete ?></h4>
                                <h3 class="text-white">All Committees Info</h3>

                            </div>
                            <div class="col-lg-2">
                                <h3>
                                    <a href="committee.php" class="btn btn-success btn-sm">Add
                    ...
                    <div class="box-body table-responsive" style="overflow-x:auto;">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM committee ORDER BY reg_date DESC ";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><img src="committee/<?php echo $row['image_name']; ?>" alt="Teacher Photo" width="50"></td>
                                                ...
                                                <div style="display: flex;">
                                                    ...
                                                    <div style="margin-right: 5px;">
                                                        <form action="" class="mt-2" method="POST" onsubmit="return confirm('Are you sure want to delete ?')" enctype="multipart/form-data">
                                                            ...
                                                            <button type="submit" name="delete_committee" value="Delete" class="confirm-delete btn btn-danger btn-xs">Delete</button>
                                                        </form>
                                                    </div>
                                                    <!-- ------ view button --------  -->
                                                    <div style="margin-right: 5px;">
