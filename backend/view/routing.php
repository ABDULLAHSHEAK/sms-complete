...
include_once("../model/add_routing.php");
...
<div class="content-wrapper">
     <section class="content-header">
    	<h1>
        	Add New Class Routing
            <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Class Routing</a></li>
        </ol>
	</section>
<!-- ----------- breadcrumb -------------------   -->
<!-- ----------- breadcrumb -------------------   -->
        	...
        	<div class="col-md-10">
            	<div class="panel"><!--panel bg-maroon--> 
                	<div class="panel-heading bg-aqua-active">	
                    	...
                    	<div class="row">
                            <div class="col-lg-10">
                                <h3 class="text-white">Add Class Routing</h3>
																																
                            </div>
                            <div class="col-lg-2">
                                <h3>
                                    <a href="all_routing.php" class="btn btn-success">View
                	...
                	<form role="form" action="" method="post" enctype="multipart/form-data">             
                      ...
                      <!-- ---------- title ---------  -->
                			<div class="form-group" id="divName">
																							<h4><?php echo  $routing_publis_alert ?></h4>
                      ...
                      <!-- ---------- Class ---------  -->
                		...
                		<div class="box-footer">
                    		<button type="submit" class="btn btn-primary" id="btnSubmit" name="add_routing">Submit</button>
                 		</div>
                	</form>
              	</div><!-- /.box -->
