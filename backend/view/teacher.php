<?php
include_once("../model/add_teacher.php");
            ...
            <div class="col-md-7">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                            ...
                            <div class="col-lg-2">
                                <h3>
                                    <a href="all_teacher.php" class="btn btn-success btn-sm">View
                                    </a>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="box-body" >
                            ...
                            <div class="form-group" id="divPhone">
                                ...
                                <div class="col-xs-4" id="divPhone1">
                                    <input type="tel" class="form-control" placeholder="0123-456-7890" name="phone" id="phone" autocomplete="off" required>
                                </div>
                            </div>
																												<!-- -------- email -------------  -->
                            <div class="form-group tt2 " id="divEmail">
                                ...
                                <div class="col-xs-6" id="divEmail1">
                                    <input type="text" class="form-control"  placeholder="Enter valid email address" name="email" id="email" autocomplete="off" required>
                                </div>
                            </div>
																												<!-- -------- photo -------------  -->
