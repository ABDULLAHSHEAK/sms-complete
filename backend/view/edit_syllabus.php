...
include_once("../model/update_syllabus.php");
...
if (isset($_GET['editId'])) {
 ...
 if (empty($id_edit)) {
  echo "<script>
 window.location.href = 'all_syllabus.php'
</script>";
 }
}
?>
...
if (isset($_GET['editId'])) {
 ...
 $query = "SELECT * FROM `syllabus` WHERE id = '$id' ";
   ...
   <div class="col-md-10">
    <div class="panel"><!--panel bg-maroon-->
     <div class="panel-heading bg-aqua-active">
      ...
      <div class="row">
       <div class="col-lg-10">
        <h3 class="text-white">Edit Syllabus</h3>

       </div>
       <div class="col-lg-2">
        <h3>
         <a href="all_syllabus.php" class="btn btn-success">Back
         </a>
        </h3>
       </div>
      </div>
       ...
       <form role="form" action="" method="post" enctype="multipart/form-data">
        <div class="box-body">
         ...
         <div class="form-group" id="divName">
          ...
          <input type="text" class="form-control" id="title" placeholder="Notice Title" name="title" autocomplete="off" value="<?= $result['syllabus_title'] ?>">
         </div>
         <!-- ---------- Class ---------  -->
         <div class="form-group" id="divName">
          <label for="title">Select Class*</label>
          <select name="class_name" id="" class="form-control">
           <option value="<?= $result['class'] ?>">Select Class</option>
           <?php
        ...
        <div class="box-footer">
         <button type="submit" class="btn btn-primary" id="btnSubmit" name="update_syllabus">Save Changes</button>
        </div>
       </form>
      </div><!-- /.box -->
