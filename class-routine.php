      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          <section class="content"> <!-- Start of table section -->
                    ...
                    <div class="table">
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT * FROM routing ORDER BY date DESC limit $limit offset $offset";
                          ...
                          ?>
                              <tr>
                                ...
                                <td> <?= $title ?></td>
                                <td> <?= "( " . $date . " )" ?></td>
                                <td> <a href="view-routine.php?routine=<?= $row['slug'] ?>" class="btn btn-primary btn-sm">দেখুন</a></td>
                              </tr>
                          <?php }
                          } ?>
                        </tbody>
            ...
            <?php
            $pagination = "SELECT * FROM routing";
              ...
              <ul class="pagination pt-5 pb-5">
                ...
                ?>
                  <li class="page-item <?= ($i == $page) ? $active = 'active' : ''; ?>">
                    <a href="class-routine.php?page=<?= $i ?>" class="page-link"><?= $i ?></a>
                  </li>
                <?php } ?>
              </ul>
            <?php } ?>
